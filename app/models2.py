...
class User(db.Model):
    ...
    add_time = db.Column(db.DateTime, default=datetime.datetime.now)  # 添加时间
...
class UserLog(db.Model):
    ...
    add_time = db.Column(db.DateTime, default=datetime.datetime.now)  # 登录时间
...
class OperateLog(db.Model):
    ...
    add_time = db.Column(db.DateTime, default=datetime.datetime.now)  # 时间
